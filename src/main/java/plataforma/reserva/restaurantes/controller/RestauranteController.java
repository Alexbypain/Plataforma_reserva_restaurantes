...
public class RestauranteController {
    ...
    @PostMapping
    public ResponseEntity crearUsuario(@RequestBody @Valid DatosCrearRestaurante datosCrearRestaurante){
    ...
    @GetMapping
    public ResponseEntity<Page<DatosListadoRestaurantes>> listadoMedicos(@PageableDefault(size = 5) Pageable paginacion) {
